...
# rename column name 
dataset1 <- rbind(OGS1_re, OGS2_re, SES1_re, SES2_re, SES3_re, SIS1_re, SIS2_re, SIS3_re) 
dataset1 <- dataset1 %>%
  rename(DBH = "DBH_Cen3", Code = "Codes_Cen3", HOM = "HOM_Cen3")

dataset2 <- rbind(SIS4_re, SIS5_re)
dataset2 <- dataset2 %>%
  rename(DBH = "DBH_Cen2", Code = "Codes_Cen2", HOM = "HOM_Cen2")

# combine recruit of all plot 
combine <- rbind(dataset1, dataset2) 
combine$ExactDate <- convertToDate(combine$ExactDate)

CenSmall2023_recruit <- combine %>%
